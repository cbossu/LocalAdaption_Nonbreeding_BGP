...
amre_abunds <- terra::rast("~/Dropbox/BGP/Network_modeling_Mignette/ConnectivityModel/AMRE/Matt_files/amered_abundance_seasonal_mean_mr_2021.tif")
...
#target.abund <- c(742, 1360, 13385, 18976,3919,58251) #new numbers (from 2023 if you code above)
...
```{r}
est.psi<-readRDS("output/MigConn/AMRE/AMRE.psi_estimates_redo.MC.ind144_rmLC.loco-pipe.ref125b.updatedMigConn.RDS")

str(est.psi,max.level=2)
est.psi$input$targetRelAbund
